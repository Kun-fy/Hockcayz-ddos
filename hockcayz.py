            ...
            while (True):
                try:
                    for i in range(num_threads):
                        ...
                        print(Fore.YELLOW + 'Respon Req: {0} | \033[32m Nuked Req: {1} | \033[38;5;111mBot Requests: {2} | \033[38;5;39mTime: {3} seconds.'.format(str(num_success), str(num_failed), str(num_bot_requests), round(elapsed_time)), end='\r', flush=True)
                    ...
                    for i in threading.enumerate():
                        if i is main_thread:
                            ...
                            print(Fore.BLUE + 'Respon Req: {0} | \033[38;5;206mNuked Req: {1} | \033[38;5;52mBot Requests: {2} | \033[38;5;220mTime: {3} seconds.'.format(str(num_success), str(num_failed), str(num_bot_requests), round(elapsed_time)), end='\r', flush=True)
                            i.join()
                    ...
                    logging.info(
                        'Respon Req: {0} | \033[33mNuked Req: {1} | \033[32mBot Requests: {2} | \033[37mElapsed Time: {3} seconds.'.format(
                            str(num_success),
                            str(num_failed),
        ...
        try:
            ...
            for i in threading.enumerate():
                if i is main_thread:
                    ...
                    print(Fore.BLUE + 'Respon Req: {0} | \033[32mNuked Req: {1} | \033[38;5;21Bot Requests: {2} | \033[38;5;220mTime: {3} seconds.'.format(str(num_success), str(num_failed), str(num_bot_requests), round(elapsed_time)), end='\r', flush=True)
                    i.join()
            ...
            logging.info(
                'Responded Req: {0} | Nuked Req: {1} | Bot Requests: {2} | Elapsed Time: {3} seconds.'.format(
                    str(num_success),
                    str(num_failed),
                    str(num_bot_requests),
                    round(elapsed_time)))
