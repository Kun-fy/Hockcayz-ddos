...
╰╯   ╰╯╰───╯    ╰─╯╰────╯╰───╯  ╰───╮  ╰───╯ ╰─╯ ╰─╯ ╰─╯
                               ╰│──╯│
                                ╰───╯''')
print(Fore.BLUE + '╔{═ * 70}╗')
print(Fore.BLUE + '║\033[38;5;220m Don't fall in love with this device{' ' * 33}\033[32m║')
print(Fore.BLUE + '║\033[38;5;220m because this calm one is always working while you sleep{' ' * 13}\033[32m║')
print(Fore.BLUE + '╚{═  * 70}╝')
            ...
            while (True):
                try:
                    for i in range(num_threads):
                        ...
                        print(Fore.YELLOW + 'Respon Req: {0} | \033[32m Nuked Req: {1} | \033[38;5;111mBot Requests: {2} | \033[38;5;206mTime: {3} seconds.'.format(str(num_success), str(num_failed), str(num_bot_requests), round(elapsed_time)), end='\r', flush=True)
